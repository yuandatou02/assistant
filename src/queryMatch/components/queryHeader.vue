<template>
    <header class="flex">
        ...
        <div class="grow flex items-center gap-x-3">
            ...
            <n-button size="small" :bordered="false" type="success" class="w-[46px]! px-[9px]!">
                刷新
            </n-button>
            <n-select size="small" class="w-[100px]! ml-7!" :options="options" />
            <n-pagination :page-slot="10" :page-count="12" />
        </div>
...
import {
    NButton, NSelect, NPagination, NAlert, NModal, NCard,
    useMessage, NIcon, NSpace, MessageReactive
} from "naive-ui";
import { RemoveCircleOutline, SettingsOutline, CloseCircleOutline } from "@vicons/ionicons5";
