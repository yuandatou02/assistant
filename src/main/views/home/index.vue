<template>
  <div class="mainContent" v-if="summonerData.summonerInfo">
      ...
      <div class="h-14 flex gap-x-2">
        ...
        <n-space class="grow" :size="[0, 0]" justify="space-between" vertical>
          ...
          <div class="flex justify-between gap-x-3">
            ...
            <div
              class="grow bg-[rgba(240,160,32,0.15)] px-[7px] text-[#f0a020] text-xs rounded-xl"
            >
    ...
    <n-card
      ...
      class="shadow! h-[402px]!"
    >
      <summonerMasteryChamp
        v-if="summonerData.champLevel"
        :max-h="378"
        :champ-list="summonerData.champLevel"
      />
    </n-card>
  </div>
